<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:55:"./application/admin/template/uploadify\upload_frame.htm";i:1559025855;}*/ ?>
<html lang="zh-cn">
<head>
        ...
        <div class="area upload-area area-checked" id="upload_area">
            <div id="uploader">
                <div class="statusBar" style="display:none;">
                    ...
                    <div class="btns" style="right: 0px;">
                        <div id="filePicker2"></div><div class="uploadBtn">开始上传</div>
                        <div class="saveBtn" style="font-size: 12px;">确定使用</div>
                    </div>
                </div>
                <div class="queueList">
