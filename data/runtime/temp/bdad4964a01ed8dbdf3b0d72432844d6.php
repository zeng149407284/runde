<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:31:"./template/pc/lists_product.htm";i:1559035162;s:44:"D:\xampp\htdocs\runde\template\pc\header.htm";i:1559272803;s:41:"D:\xampp\htdocs\runde\template\pc\top.htm";i:1559035162;s:44:"D:\xampp\htdocs\runde\template\pc\footer.htm";i:1559035162;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
/*product_home*/
.content_home .product_home {
}
.content_home .product_home .list li {
	float: none;
	padding: 40px 0;
}
.content_home .product_home .list li .pr1 {
}
.content_home .product_home .list li .pr1 .pic {
	margin-left: 70px;
	width: 40%;
	height: 205px;
	overflow: hidden;
...
.content_home .product_home .list li .pr1 .mode .l1 {
	font-size: 22px;
	color: #135ac4;
}
.content_home .product_home .list li .pr1 .mode .l2 {
	margin: 15px 0 30px 0;
	font-size: 16px;
	color: #3b3b3b;
}
.content_home .product_home .list li .pr1 .mode .l3 {
	line-height: 30px;
	font-size: 14px;
	color: #646466;
	height: 6.5em;
...
.content_home .product_home .list .pr_bj {
	background: #f3f6fa;
	overflow: hidden;
}
.content_home .product_home .list li .pr1 .lt {
	margin-left: 0;
	margin-right: 70px;
	float: left;
}
...
.content_home .product_home .list li .pr1 .mode {
	margin: 20px 0;
}
}
.pages {
...
<div class="content_home">
  ...
  <div class="product_home">
    <ul class="list">
    <?php  $typeid = "";  if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> "", ); $tagList = new \think\template\taglib\eyou\TagList; $_result_tmp = $tagList->getList($param, 4, "", "", "desc");if(is_array($_result_tmp) || $_result_tmp instanceof \think\Collection || $_result_tmp instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result = $_result_tmp["list"]; $__PAGES__ = $_result_tmp["pages"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$field["title"] = text_msubstr($field["title"], 0, 100, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$mod = ($e % 2 );$i= intval($key) + 1;if($mod == '0'): ?><div class="pr_bj"><?php endif; ?>
      <div class="g_cw">
        <li> <a href="<?php echo $field['arcurl']; ?>" target="_blank">
          <div class="pr1">
            <p class="pic <?php if($mod == '0'): ?>lt<?php endif; ?>"><img class=" g_imgf" src="<?php echo $field['litpic']; ?>"></p>
            <div class="mode">
              <p class="l1"><?php echo $field['title']; ?></p>
              <p class="l2"><?php echo $field['typename']; ?></p>
              <p class="l3"><?php echo html_msubstr($field['seo_description'],0,140,true); ?></p>
            </div>
          </div>
          </a> </li>
      </div>
      <?php if($mod == '0'): ?></div><?php endif; ++$e; $aid = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; ?>   
      </div>
    </ul>
  </div>
  <div class="pages">
