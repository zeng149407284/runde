<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:36:"./template/pc/lists_article_anli.htm";i:1559035162;s:44:"D:\xampp\htdocs\runde\template\pc\header.htm";i:1559272803;s:41:"D:\xampp\htdocs\runde\template\pc\top.htm";i:1559035162;s:44:"D:\xampp\htdocs\runde\template\pc\footer.htm";i:1559035162;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8" />
...
<style>
/*cases_home*/
.content_home .cases_home { }
.content_home .cases_home .ca_list { }
.content_home .cases_home .ca_list .list { }
.content_home .cases_home .ca_list .list li { margin-bottom: 40px; background: #f3f6fa; }
.content_home .cases_home .ca_list .list li:nth-child(4n+4) { margin-bottom: 0; }
.content_home .cases_home .ca_list .list li .left { margin-right: 25px; float: left; display: inline-block; font-size: 0; height:258px; overflow:hidden; }
.content_home .cases_home .ca_list .list li .mode { padding: 25px 25px 0 0; }
.content_home .cases_home .ca_list .list li .mode p { line-height: 25px; color: #4a4a4b; letter-spacing: -0.5px; }
.content_home .cases_home .ca_list .list li .mode .p1 { font-size: 16px; color: #135ac4; overflow: hidden; height:1.5em;  }
.content_home .cases_home .ca_list .list li .mode .p2 { margin: 10px 0 15px 0; font-size: 12px; color: #a6a7aa; }
.content_home .cases_home .ca_list .list li .mode .p3 { margin: 10px 0 10px 0;  overflow: hidden; height:7em; }
.content_home .cases_home .ca_list .list li .mode a {  }
.content_home .cases_home .ca_list .list li .mode .ca_jt { margin-left: 3px; vertical-align: middle; width: 12px; }

.content_home .cases_home .ca_list .list li:nth-child(2n+2) .left { margin-left: 25px; margin-right: 0; float: right; }
.content_home .cases_home .ca_list .list li:nth-child(2n+2) .mode { padding: 25px 0 0 25px; }

@media (max-width: 750px) {
	.content_home .cases_home .ca_list .list li .left { margin-right: 0; float: none; width: 100%; overflow:inherit; height:auto;}
	.content_home .cases_home .ca_list .list li .ca_ct { width: 100%; }
	.content_home .cases_home .ca_list .list li .mode { padding: 25px; }

	.content_home .cases_home .ca_list .list li:nth-child(2n+2) .left { margin-left: 0; margin-right: 0; float: none; }
	.content_home .cases_home .ca_list .list li:nth-child(2n+2) .mode { padding: 25px; }
}

.pages { margin-top:60px; text-align: center; clear: both; }
.pages ul{ margin-top:60px; display: inline-block;}
.pages ul li{ display:inline-block; box-sizing:border-box;}
.pages ul li a { padding: 10px 17px; border: solid transparen 1px; }
.pages ul li a:hover { background: #0a64be; border-color: #e9eff9; color: #fff; }
.pages ul li .on { padding: 10px 17px; background: #0a64be; border: solid #e9eff9 1px; color: #fff; }
...
<div class="content_home"> <div class="top">
    <div class="g_cw">
      <div class="g_title">
  ...
  <ul class="list">
    ...
    <li> <a href="<?php echo $field['arcurl']; ?>" target="_blank">
      <p class="left"> <img class="ca_ct g_imgf" src="<?php echo $field['litpic']; ?>"> </p>
      <div class="mode">
        <p class="p1"><?php echo $field['title']; ?></p>
        <p class="p2"><?php echo MyDate('Y-m-d',$field['add_time']); ?></p>
        <p class="p3"><?php echo html_msubstr($field['seo_description'],0,140,true); ?></p>
        查看详情 <img class="ca_jt" src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/ca_jt.svg"> </div>
      </a> </li>
